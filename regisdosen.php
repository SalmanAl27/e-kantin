...
<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
    <div class="panel panel-default">
        <div class="panel-heading">
            <strong>  Daftar sebagai Dosen</strong>  
        </div>
        <div class="panel-body">
            ...
            <br/>
                ...
                <div class="form-group input-group">
                    <span class="input-group-addon"><i class="fa fa-tag"  ></i></span>
                    <input type="text" name="nip" id="nip" class="form-control" placeholder="NIP" autocomplete="off">
                </div>
                <div class="form-group input-group">
                ...
                <hr />
                Sudah punya akun ?  <a href="login.php?halaman=logindosen" >Masuk</a>
            </form>
            <?php 

            if (isset($_POST["daftar"]) ) {

                if(registrasidosen($_POST) > 0) {
                    echo "<div class='alert alert-info'> User berhasil ditambahkan </div>";
                    echo "<script>
                        document.location.href = 'login.php?halaman=logindosen';
                    </script>";
                } else {
