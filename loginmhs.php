...
<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
  <div class="panel panel-default">
      <div class="panel-heading">
        <strong>  Masuk sebagai Mahasiswa</strong>  
      </div>
      <div class="panel-body">
        <form role="form" method="post"><br />
          ...
          <hr />
          <a href="regis.php?halaman=regismhs" > Buat akun </a> 
        </form>
        <?php
        if (isset($_POST["masuk"]) ) {
          ...
          $result = mysqli_query($conn, "SELECT * FROM usermhs WHERE nim = '$nim'");
          ...
          if (mysqli_num_rows($result) === 1) {
            ...
            echo "<div class='alert alert-danger'> NIM atau password salah </div>";
          }
